...
<body>
		...
		<div class="id_wrap">
			...
			<div class="form_wrap">
				...
				<form id="id_form" class="email">
					<input type="text" name="id" id="email_id" placeholder="아이디를 입력해주세요.">
					<input type="email" id="email" name="email" placeholder="이메일을 입력해주세요.">
					<button type="button" id="email_search">비밀번호 찾기</button>
				</form>

				<form id="id_form" class="tel">
					<input type="text" name="id" id="tel_id" placeholder="아이디를 입력해주세요.">
	...
	<section id="mobile_id_find">
		...
		<form id="mobile_email" action="m_member_pw_result">
			<span>아이디</span>
			<input type="text" id="m_email_id" placeholder="아이디를 입력해주세요." name="id">
		...
		<form id="mobile_tel" action="m_member_pw_result">
			<span>아이디</span>
			<input type="text" id="m_tel_id" placeholder="아이디를 입력해주세요." name="id">
