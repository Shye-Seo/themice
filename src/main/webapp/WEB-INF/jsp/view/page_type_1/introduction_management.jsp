...
<style type="text/css">
#preferences .inner .category a:nth-child(2) {
	color: #EA933C;
    border-bottom: solid;
    border-width: 3px;
    border-color: #EA933C;
				...
				<div class="main_management">
					...
					<div class="contents_area">
						...
						<div class="right_area">
							<form method="post" action="introduction_management" enctype="multipart/form-data">
								<input type="file" name="img" id="main_img" accept="image/*" onchange="setThumbnail(event);">
								<div class="upload_item_1" id="image_container">
									<span>* 고해상도 이미지를 사용해주세요.</span>
