					...
					$(function () {
						...
						$('#email_search').click(function(){
							...
							$.ajax({
								...
								success : function(data) {
									if ($.trim(data) == 1) {
										var url = "business_pw_email_certification?business_num=" + business_num + "&certification_type=" + email;
						...
						$('#tel_search').click(function(){
							...
							$.ajax({
								...
								success : function(data) {
									if ($.trim(data) == 1) {
										var url = "business_pw_tel_certification?business_num=" + business_num + "&certification_type=" + tel;
										window.open(url, "", "width=" + width + ", height=" + height + ", left=" + left + ", top=" + top);
									} else {
										alert('일치하는 정보가 없습니다.');
									}
