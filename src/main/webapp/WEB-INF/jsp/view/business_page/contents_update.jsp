...
<%@ page import="com.contents.ContentsVO" %>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<body>
	...
	<section>
		...
		<form method="post" action="contents_update" enctype="multipart/form-data" id="form_data">
			<div class="page_1">
				<div class="infomation_area">
					...
					<div class="right">
<%-- 						<input type="text" placeholder="20자 이내로 입력해주세요." name="title" id="title" class="input_1" value="<%=   %>"> --%>
