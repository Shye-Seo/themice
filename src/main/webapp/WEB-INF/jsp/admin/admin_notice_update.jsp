	...
	<section>
		<form name="uploadForm" id="uploadForm" enctype="multipart/form-data"
			...
			<table>
				...
				<tr>
					<td>등록일</td>
					<td><input type="date" name="start_day"> ~ <input
						type="date" name="end_day"></td>
				</tr>
				...
				<tr>
					...
					<td>
						<div id="dropZone"
							style="width: 100%; height: 300px; border-style: solid; border-color: black;">
				...
				<tr>
					<td colspan="2"><textarea name="ir1 contents" id="ir1" rows="10" cols="100"></textarea>
					</td>
				</tr>
			</table>
